        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="lg:ml-10">
            <h1 className="font-serif text-center text-green-700">
              ...
              <h3 className="text-center font-serif  text-slate-800 md:text-3xl">1+ year experienced in IT and a software developer. I have completed six-months of full-stack web development bootcamp training in 2022. I have been focusing on MERN Stack technologies for the last year.  I'm developing full-stack projects with react and node. I also have knowledge about NoSQL database (Mongo DB). I love doing hobby projects and learning new technologies.</h3>
              <br/>
