...
const Hero = () => {
  ...
  return (
    <>
      <h1 className="text-3xl lg:text-5xl font-semibold my-5 text-red-500 text-center md:text-left"><img className="float-right" width="30px" src="https://reactdeveloper.site/logobg.png" alt="hblogo" />Hüseyin BATTAL</h1>
